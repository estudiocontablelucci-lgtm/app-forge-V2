/**
 * Ciclo 2 de Agustin: el programa real que dio origen a la app.
 *
 * Vivia dentro de ForgeApp y se instalaba solo en toda instalacion nueva, asi
 * que cualquier persona que entraba por primera vez veia el mesociclo de otro
 * —con sus kilos y sus notas de lesion— como si fuera propio. Ahora una cuenta
 * nueva arranca vacia; esto queda solo como fuente de `npm run gen:programa`,
 * que genera el .xlsx para reimportarlo.
 */

export const SESIONES_CICLO2 = [
