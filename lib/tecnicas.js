...
export const TECNICAS = {
  dropset: {
    ...
    abrev: "DS",
    familia: "intraserie",
    // El simbolo del chip. Estaba escrito a mano en la UI —una flecha para
    // abajo, "baja el peso"— y con una sola tecnica pasaba por adorno. Con dos
    // deja de serlo: una flecha hacia abajo sobre una isometrica dice justo lo
    // contrario de lo que hay que hacer.
    icono: "↓",
    // El nombre para la fila del programa, donde el chip comparte renglon con
    // el grupo muscular. Vive aca y no en la UI por lo mismo que el icono.
    corto: "Dropset",
    pasos: 2,
    aplica: "ultima",
  ...
  isoest: {
    ...
    familia: "intraserie",
    icono: "⏸",
    // "Isométrica en estiramiento" entero ocupaba dos renglones adentro de la
    // fila y empujaba el resto.
    corto: "Isométrica",
