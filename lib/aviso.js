...
/**
 * El audio YA esta vivo (de un descanso anterior de la misma sesion).
 *
 * Se pregunta sin tocar nada, y esa es toda la gracia. `despertarAudio()` crea
 * el contexto y llama a `resume()`; sin un gesto del usuario el navegador deja
 * esa promesa PENDIENTE en vez de rechazarla, asi que preguntar con
 * `despertarAudio` deja un intento colgado esperando para siempre.
 */
export function audioVivo() {
