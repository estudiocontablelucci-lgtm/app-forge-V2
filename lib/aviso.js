 ...
 *
 * Si el beep agendado ya salio no se toca nada — repetirlo seria un doble aviso
 * dos décimas despues, que es peor que uno solo.
 */
export function sonarAhora({ sonido = true, vibracion = true } = {}) {
  if (sonido) {
    if (beepPendiente()) { cancelarBeep(); beepYa(); }
